...
namespace SOA_DataAccessLibrary
{
    ...
    public class Mtc_ProcessType : IParameterSource
    {
        ...
        public void writeTo(XElement UncProcessType)
        {
            ...
            var ProcessType = UncProcessTypeHelper.addChild("ProcessType").setAttribute("name", name);
    ...
    public class Mtc_Range_Boundary : AbstractValue
    {
        ...
        public Mtc_Range_Boundary(XElement datasource, Mtc_ProcessType processType, string rangeName, RangeType rType)
        {
            try
            {
                switch (rType)
    ...
    public class Mtc_Range_End : Mtc_Range_Boundary
    {
        ...
        public Mtc_Range_End(XElement datasource, Mtc_ProcessType processType, string rangeName, RangeType rType)
    ...
    public class Mtc_Range_Start : Mtc_Range_Boundary 
    {
        ...
        public Mtc_Range_Start(XElement datasource, Mtc_ProcessType processType, string rangeName, RangeType rType)
            : base(datasource, processType, rangeName, rType) { }
    }
    ...
    public class Soa_Activity 
    {
        ...
        public Unc_ProcessTypes ProcessTypes
        {
            get { return Unc_CMCs.ProcessTypes; }
