...
namespace SoA_DataAccessLib_UnitTest
{
    public class Tests
    {
        [SetUp]
        ...
        public void Test1()
        {
            ...
            // Looping through a SOA's Taxons looking for known Taxon Names will also be very common search refinement
            ...
            Assert.AreEqual("Measure.Voltage.AC.LowVoltage", technique_name1, "Failed TemplateTechnique Name");
            ...
            Assert.IsTrue(Technique.Taxon.ResultTypes.Contains("voltage"), "Failed Result Types");
            Assert.IsTrue(Technique.Taxon.ResultTypes.Count == 1, "Failed Result Types");
            ...
            Assert.AreEqual("at", result_start.test, "Failed Result Start Type");
            Assert.AreEqual(0.0, (double)result_start.BaseValue, "Failed Result Start Value");
            Assert.AreEqual("at", result_end.test, "Failed Result End Type");
            Assert.AreEqual(110, (double)result_end.BaseValue, "Failed Result End Value");
            ...
            Assert.AreEqual("Measure.Voltage.AC.LowVoltage.Uncertainty.Certified", functionName, "Failed CMCFunction Name");
            ...
            Assert.AreEqual("k_nominal * nominal + k_range * range", functionExpression, "Failed CMCFunction By Name");
            ...
            Assert.AreEqual(4, functionSymbols.Count, "Failed Function Symbols");
            ...
            Assert.AreEqual(2, rangeVariables.Count, "Failed Distinct Range Variables");
            ...
            Assert.AreEqual(2, functionVariables.Count, "Failed Distinct Function Variables");
            ...
            Assert.AreEqual(2, functionConstants.Count, "Failed Distinct Function Constants");
            ...
            Assert.AreEqual(2, assertionValues2.Count, "Failed Distinct Assertion Values");
            ...
            Assert.AreEqual(3, assertionValues1.Count, "Failed Distinct Assertion Values");
            ...
            Assert.AreEqual("k_nominal", constantValue1.const_parameter_name, "Failed ConstantValue Const_parameter_name");
            Assert.AreEqual("0.0001", constantValue1.ValueString, "Failed Get ConstantValue Value");
            Assert.AreEqual("ratio", constantValue1.Quantity, "Failed Get ConstantValue Quantity");
            Assert.AreEqual("percent", constantValue1.uom_alternative, "Failed Get ConstantValue UOM Alternative");
            ...
            Assert.AreEqual(0.000001, baseValue, "Failed Converting a ConstantValue's Value To its Base UOM Value");
            ...
            Assert.AreEqual(2.25E-05, uncertainty, "Failed Uncertainty Calculation");
            ...
            Assert.AreEqual(0.01, baseValue, "Failed Converting a ConstantValue's Value To its Base UOM Value");
            ...
            Assert.AreEqual(0.01, value, "Failed Converting a ConstantValue's Value To its Base UOM Value");

            constantValue1.ValueString = "1";
            baseValue = (double)constantValue1.BaseValue;
            Assert.AreEqual(1, baseValue, "Failed Converting a ConstantValue's Value To its Base UOM Value");
        }
    }
}