...
namespace SOA_DataAccessLib
{
    ...
    public class Mtc_Definition
    {
        ...
        public Mtc_Definition(string value)
        {
            Value = value;
        }
    ...
    public class Mtc_Result
    {
        ...
        public Mtc_Result(string name, string qty)
        {
            Name = name;
            Quantity = UomDataSource.getQuantity(qty);
        }
    ...
    public class Mtc_Results : IEnumerable<Mtc_Result>
    {
        ...
        {
            var result = new Mtc_Result(name, qty);
            results.Add(result);
        }
        ...
        public Mtc_Results()
        {
        } // Needed when Mtc_Taxon is null.  Returns an empty Mtc_Results
    ...
    public class Mtc_Parameter
    {
        ...
        public Mtc_Parameter(string name, string quantity, bool optional)
        {
            _name = name;
    ...
    public class Mtc_Parameters : IEnumerable<Mtc_Parameter>
    {
        ...
        public Mtc_Parameters()
        {
        } // Needed when Mtc_Taxon is null.  Returns an empty Mtc_ProcessParameters
    ...
    public class Mtc_Taxon : IParameterSource
    {
        ...
        // Add an SoA Mtc_Taxon via the taxon from the MT Editor xml
        public Mtc_Taxon(Unc_Taxon parent, MT_DataAccessLib.Taxon Taxon)
        {
            this.parent = parent;
            name = parent.name;
            definition = new Mtc_Definition(Taxon.Definition);
            string qty = "";
            parameters = new();
    ...
    public class Mtc_Function
    {
        ...
        public Mtc_Function(XElement functionElement, IParameterSource parameterSource)
        {
            ...
            techniqueName = parameterSource.Name;
    ...
    public class Mtc_Roles : IEnumerable<Mtc_Role>
    {
        ...
        private void loadRoles(MtcSpaceHelper mtcSpaceHelper)
        {
            ...
            foreach (XElement el in els)
            {
                ...
                foreach (var dt in el.Elements().Descendants())
                {
                    role.DeviceTypes.Add(dt.Value);
                }
                roles.Add(role);
            }
        }
    ...
    public class Unc_Ranges : IEnumerable<Unc_Range>
    {
        ...
        public Unc_Ranges()
        {
        } // Needed if parent has no Ranges element.  Return empty Unc_Ranges
    ...
    public class Unc_Assertion
    {
        ...
        private string name = "";
        private string value = "";
        private static string[] valid_types = { "", "generic", "equipment" };
    ...
    public class Unc_CMCFunction
    {
        ...
        {
            this.template = Template;
            this._techniqueName = Template.TemplateTechnique.Name;
            this.cases = Cases;
            this._name = Name;
        }
        ...
        public Unc_CMCFunction(XElement datasource, Unc_Template template)
        {
            try
            {
                ...
                UncSpaceHelper uncSpaceHelper = new UncSpaceHelper(datasource);
                _name = uncSpaceHelper.getAttribute("name");
                _techniqueName = template.TemplateTechnique.Name;
    ...
    public class Unc_Template
    {
        ...
        public string GetCMC_Category()
        {
            foreach (Unc_CMC cmc in cMCs.CMC.ToList())
            {
                ...
                {
                    var matches = template.CMCUncertaintyFunctions.Where(f => f.TechniqueName == this.templateTechnique.Name);
                    if (matches.ToList().Count > 0)
                    {
                        return cmc.Category.Name;
                    }
                }
            }
            return "";
        ...
        public IList<Mtc_CMCUncertainty> getCMCUncertaintyTechniqueName(string techniqueName)
        {
            return mtcTechnique != null ? mtcTechnique.CMCUncertainties.Where(f => f.TechniqueName == techniqueName).ToList() : new List<Mtc_CMCUncertainty>();
        }
    ...
    public class Unc_Templates : IEnumerable<Unc_Template>
    {
        ...
        public void Remove(Unc_Template template)
        {
    ...
    public class Unc_CMCList : IEnumerable<Unc_CMC>
    {
        ...
        public void Remove(Unc_CMC cmc)
        {
            cmcList.Remove(cmc);
        }
    ...
    public class Unc_Techniques : IEnumerable<Unc_Technique>
    {
        ...
        public List<Unc_Technique> getByTaxonName(string taxonName)
        {
            return techniques.Where(t => t.Taxon == taxonName).ToList();
        }
        ...
        public void Remove(Unc_Technique technique)
        {
            ...
            foreach (Unc_CMC cmc in cmcs)
            {
                foreach (Unc_Template template in cmc.Templates)
                {
                    ...
                    {
                        if (function.name == technique.Technique.CMCUncertainties[0].function_name)
                        {
    ...
    {
        private List<Unc_Taxon> taxons = new List<Unc_Taxon>();
        ...
        public List<string> Names()
        {
            ...
            taxons.ForEach(t => { names.Add(t.name); });
            return names;
        }

        public void Remove(Unc_Taxon taxon, Unc_Techniques techniques = null)
        {
            taxons.Remove(taxon);
        }
    ...
    public class Soa_Activity
    {
        ...
        {
            var template = Templates.SingleOrDefault(t => t.TemplateTechnique.Name == name);
            return template;
        }
