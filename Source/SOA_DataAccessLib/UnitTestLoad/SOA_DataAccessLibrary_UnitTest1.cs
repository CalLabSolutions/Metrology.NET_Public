...
namespace SOA_DataAccessLibrary_UnitTest1
{
    ...
    public class SOA_DataAccessLibrary_UnitTest1
    {
        ...
        public void TestLoad()
        {
            ...
            var result_range = SampleSOA.CapabilityScope.Activities[0].Techniques[0].Technique.ProccessResultRange[0];
            ...
            string CMCFunctionName = template.CMCFunctions[0].Name;
            Assert.AreEqual<string>("Measure.Voltage.AC.LowVoltage.Uncertainty.Certified", CMCFunctionName, "Failed CMCFunction Name");
            ...
            string CMCFunctionText = template.getCMCFunctionText(CMCFunctionName);
            Assert.AreEqual<string>("k_nominal * nominal + k_range * range", CMCFunctionText, "Failed CMCFunction By Name");
            ...
            var functionSymbols = template.getCMCFunctionSymbols(CMCFunctionName);
            ...
            var rangeVariables = template.getCMCFunctionRangeVariables(CMCFunctionName);
            ...
            var functionVariables = template.getCMCFunctionVariables(CMCFunctionName);
            ...
            //  The function symbols with same name must have their values set before the function may be evaluated.
            var functionConstants= template.getCMCFunctionConstants(CMCFunctionName);
            ...
            var assertionNames = template.getCMCFunctionAssertionNames(CMCFunctionName); 
            ...
            var assertionValues2 = template.getCMCFunctionAssertionValues(CMCFunctionName, "Connection");
            ...
            var assertionValues1 = template.getCMCFunctionAssertionValues(CMCFunctionName, "Resolution");
            ...
            var range1 = template.CMCFunctions[0].Cases[0].Ranges[0].Ranges[0];     
            ...
            {
                template.setCMCFunctionSymbol(CMCFunctionName, constant.const_parameter_name, (double)constant.BaseValue);
            }
            template.setCMCFunctionSymbol(CMCFunctionName, "nominal", 2.5);
            template.setCMCFunctionSymbol(CMCFunctionName, "range", 10);

            // With all the functions values now set, the function may be evaluated.
            double uncertainty = (double)template.evaluateCMCFunction(CMCFunctionName);
